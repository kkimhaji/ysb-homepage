...
FACULTY = [
 ...
 ("민순홍","Soonhong Min","M","교수","Professor",
  "지속가능성과 ESG 전략, 공급망 전략, B2B 파트너쉽, 로지스틱 ",
  "Sustainability and ESG Strategy; Supply Chain Strategy; Business-to-Business partnerships; AI-based Supply Chain Operations; Logistics Service Quality",
